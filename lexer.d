...
string[2][] compoundTokens = [];
 ...
 string[] keywords = ["def","state","new","drop","dup","fwd","skip","assert","observe","and","not","if","then","else","true","false","or","topology","nodes","links","parameters","packet_fields","programs","with","query"];
