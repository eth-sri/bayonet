...
for i in range(n):
  if i>0:
    printLink("S"+str(4*i-3),3,"S"+str(4*i+0),1)
    print()
  printLink("S"+str(4*i+0),2,"S"+str(4*i+1),1)
  printLink("S"+str(4*i+0),3,"S"+str(4*i+2),1)
  printLink("S"+str(4*i+0),4,"S"+str(4*i+3),1)
  printLink("S"+str(4*i+3),2,"S"+str(4*i+2),3)
  printLink("S"+str(4*i+2),2,"S"+str(4*i+1),2)
  print()
printLink("S"+str(4*n-3),3,"H1",1,False)
